...
namespace our {
    ...
    void ForwardRenderer::render(World* world){
        ...
        glm::vec4 forwardInCameraSpace =  glm::vec4(0.0,0.0,-1.0f,0.0);
        glm::vec3 cameraForward = glm::vec3(forwardInCameraSpace * camera->getOwner()->getLocalToWorldMatrix());

        std::sort(transparentCommands.begin(), transparentCommands.end(), [cameraForward](const RenderCommand& first, const RenderCommand& second){
            //TODO: (Req 9) Finish this function
            // HINT: the following return should return true "first" should be drawn before "second".
            float distanceFirst  = glm::dot(cameraForward, first.center - cameraForward);
            float distanceSecond  = glm::dot(cameraForward, second.center - cameraForward);
        ...
        if(this->skyMaterial){
            ...
            this->skyMaterial->shader->set("transform", alwaysBehindTransform * camera->getProjectionMatrix(windowSize) * camera->getViewMatrix() * modelMatrix);
