...
namespace our {
    ...
    public:
        ...
        glm::vec3 positionSensitivity = {5.0f, 5.0f, 5.0f}; // The unity per second of camera movement if WASD is pressed
        float speedupFactor = 2.5f; // A multiplier for the positionSensitivity if "Left Shift" is held.
