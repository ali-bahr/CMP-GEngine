...
class EntityTestState: public our::State {
    ...
    void onDraw(double deltaTime) override {
        ...
        //DONE TODO: (Req 8) Change the following line to compute the correct view projection matrix
        ...
        for(auto& entity : world.getEntities()){
            ...
            //DONE TODO: (Req 8) Complete the loop body to draw the current entity
            ...
            meshRenderer->material->shader->set("transform", VP * matrix);
